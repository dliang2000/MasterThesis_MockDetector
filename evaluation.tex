...
\begin{figure}
	...
	public void testMisconfiguredToolchain() throws Exception {
		//        			   								mockAPI: |\cmark|
		MavenSession session = |\color{red}mock| ( MavenSession.class );
		MavenExecutionRequest req = new DefaultMavenExecutionRequest();
		//     mock invocation: |\cmark| $\rightarrow$ focal method: |\xmark|
		when( session.|\color{red}getRequest()| ).thenReturn( req ); |\label{line:mock}|
		
		ToolchainPrivate[] basics =
		//     					 						focal method: |\cmark|
			toolchainManager.|\color{red}getToolchainsForType|("basic", session); |\label{line:real}|
