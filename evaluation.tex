...
\begin{table*}
	\centering
	\caption[Benchmarks' LOC plut Soot and Doop analysis run-times.]{Our suite of 8 open-source benchmarks (8000--117000 LOC) plus our microbenchmark. Soot and Doop analysis run-times.}
