...
In this section, we present the high level definitions for mockness using Jimple IR. The Soot implementation looks for these Jimple IRs during the "gen" action for each statement. The declarative Doop analysis is quite close to high level definitions.
...
In the 3 mocking libraries, we consider for a total of 9 mock source creation methods. For the Jimple IR definition , we pick Mockito's \texttt{<org.mockito.Mockito: java.lang.Object mock(java.lang.Class)>} for representation purpose.
