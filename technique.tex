...
%Similarly to the dataflow analysis, the declarative approach propagates mockness from known mock sources, through the statements in the intermediate representation, to potential mock invocation sites

A mock object may be created and carried in several ways: it could be the return value from a mock creation sites; it could be a casted version of the return value from a mock creation sites in the intermediate level if the object is not of type \texttt{java.lang.Object}; it could be a copy of already-flagged mock; it could be a field mock object defined via annotations, in constructor \texttt{<init>}, or in \texttt{@Before}/\textit{setUp()} methods; or it could be hold by an array or container before re-accessing it.

Therefore, the following is our definition for mockness:

Object x is a mock object if it is either the return value from a mock creation sites (including field mocks), or if the initial mock definition reaches a use point through casting, transitive definition, or passed along through mock-containing arrays or containers. We consider paths over the intraprocedural control-flow graph and interprocedural call graph edges.


In this section, we present the high level definitions for different categories of mockness using Jimple IR. The Soot implementation looks for these Jimple IRs during the ``gen" action for each statement. The declarative Doop analysis is quite close to high level definitions.

In the following Jimple IR definitions, the ones highlighted in red boxes are considered as mockness, and the ones highlighted in teal boxes are considered as mock-containing array or container.
...
java.lang.Object r1;
|\colorbox{red}{r1}| = staticinvoke <org.mockito.Mockito:
			java.lang.Object mock(java.lang.Class)>
			(class "Ljava/lang/Object;");

\end{lstlisting}

In the 3 mocking libraries, we consider a total of 9 mock source creation methods. For the Jimple IR definition , we pick Mockito's \texttt{<org.mockito.Mockito: java.lang.Object mock(java.lang.Class)>} for representation purpose.
...
X r1;
java.lang.Object $r2;
|\colorbox{red}{\$r2}| = staticinvoke <org.mockito.Mockito: 
			java.lang.Object mock(java.lang.Class)>
			(class "X;");
|\colorbox{red}{r1}| = (X) $r2;
\end{lstlisting}
...
public void init() {
	...
	|\colorbox{red}{\$r1}| = staticinvoke <org.mockito.Mockito:
				...
				(class "X;");
	|\colorbox{red}{\$r2}| = (X) $r1;
	|\colorbox{red}{r0.<TESTCLASS: X x>}| = $r2;
}
\end{lstlisting}
...
|\colorbox{red}{\$r2}| = staticinvoke <org.easymock.EasyMock:
			java.lang.Object createMock(java.lang.Class)>
			(class "java.lang.Object;");
|\colorbox{red}{r1}| = (java.lang.Object) $r2;
$r3 = newarray (java.lang.Object)[1];
|\colorbox{teal}{\$r3}|[0] = r1;
\end{lstlisting}

Similarly, for mock-containing container (write method), the Jimple IR definition is as follow:
...
|\colorbox{red}{\$r2}| = staticinvoke <org.mockito.Mockito: 
			java.lang.Object mock(java.lang.Class)>
			(class "X;");
|\colorbox{red}{r3}| = (X) $r2;
virtualinvoke |\colorbox{teal}{\$r1}|.<java.util.ArrayList: boolean add(java.lang.Object)>(r3);
\end{lstlisting}

The container APIs for read and write methods are hard-coded in both Soot and Doop implementations.
